...
export function registerTools(server: McpServer) {
  ...
  server.registerTool("erd_patch_propose", {
    description: "Prepare granular table, column, index, constraint, and relationship changes with a non-writing preview, breaking-change classification, and ordered PostgreSQL/MySQL forward and rollback SQL. New IDs are generated by the server. Ask for explicit confirmation before apply.",
